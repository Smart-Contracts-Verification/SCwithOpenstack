...
})({"dJf9j":[function(require,module,exports) {
...
async function sendData(account) {
    var data = {
        "account": account
    };
    const resp = await fetch("http://127.0.0.1:3000/metamaskid", {
        method: "POST",
        mode: "cors",
        headers: {
    ...
    }).then(window.location.href = "http://127.0.0.1:3000/test-main.html");
}
...
},{"@metamask/onboarding":"gSj9U","@parcel/transformer-js/src/esmodule-helpers.js":"gPvpN"}],"gSj9U":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["dJf9j","7SwCM"], "7SwCM", "parcelRequire372d")

//# sourceMappingURL=login.44ee11f1.js.map
