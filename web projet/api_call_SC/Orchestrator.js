...
var vnffactorycontract = new web3.eth.Contract(vnffactoryabi, vnffactoryAddress.addressSC);
   ...
   /**************************************************** */
    /**************************************************** */
    /**********************  Fetch VNF****************************** */
export async function Fetch_VNF(_CPU, _Storage, _RAM ) {
    ...
    /**************************************************** */
    /**********************  Deploy VNF****************************** */
export async function Create_VNFSC(accountmetamask) {
...
export async function createVNF(accountmetamask,_vnfid, _vnfdid,_CPU, _Storage, _RAM) {
...
export async function DeleteVNF(VNFID) {
...
/**************************Scale VNF************************** */
  ...
  export async function SCALE_OUT_VNF(VNFID, _CPU, _Storage, _RAM) {
